...
Pod::Spec.new do |s|
  ...
  s.author             = { "Ivan Esparza" => "ivanebernal@gmail.com" }
  # Or just: s.author    = "Ivan Esparza"
  # s.authors            = { "Ivan Esparza" => "ivanebernal@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Ivan Esparza"
  ...
  s.source       = { :git => "https://github.com/ivanebernal/KnobControl.git", :tag => "1.0.0" }
